...
public class BaseTest {
    ...
    public WebDriver initializeDriver() throws IOException {
        ...
        FileInputStream fis = new FileInputStream(System.getProperty("user.dir")
                + "/src/main/java/RahulshettyAccademyJavaCourse/resources/GlobalData.properties");
        prop.load(fis);
    ...
    public LandingPageByGedo launchApplication() throws IOException {
        driver = initializeDriver();
        landingPage = new LandingPageByGedo(driver);
        landingPage.goTo();
        return landingPage;
    }
